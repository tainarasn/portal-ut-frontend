...
LABEL maintainer="Tainara Novaes <tainarasn.sba@gmail.com>" \
      org.label-schema.name="portal-ut-frontend" \
      org.label-schema.description="portal.ut frontend image." \
      org.label-schema.vendor="Tainara Novaes"
